...
function userprofile ($user, $msg = 0)
{
    ...
    $user_templates->set_file(array('profile'=>'profile.thtml','row'=>'commentrow.thtml','strow'=>'storyrow.thtml','plgtable'=>'pluginpoststable.thtml','plgprow'=>'pluginpostsrow.thtml','plgsrow'=>'pluginstatsrow.thtml'));
    ...
    PLG_profileStatsVariablesDisplay ($user, $user_templates);
