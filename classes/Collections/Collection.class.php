...
abstract class Collection
{
     ...
     * @var array */
    protected $cache_tags = array('dailyquote_quotes', 'dailyquote_cat');

    /** Cache key constructed from SQL query and parameters.
     * @var string */
    private $_cache_key = '';

    /** Flag to use the cache. Normally true but turned off for RAND().
     * @var boolean */
    ...
    {
        if ($this->_useCache) {
            $this->_cache_key = md5($key . $this->_qb->getSQL() . json_encode($this->_qb->getParameters()));
